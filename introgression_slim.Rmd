...
Finally we execute the simulation (we simulate 200Mb of sequence in each sampled individual, with the recombination rate $10^{-8}$ per bp per generation):

```{r, eval = !file.exists("./results/output_ts_slim.trees")}
ts <- slim(
