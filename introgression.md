...
we have all the samples we simulated:
    ...
    #> 
    #> oldest node: 9446169 backward time units
...
But it works.
    ...
    #> 937 mutations (out of 437992) have been removed because they appeared on a position already occupied by another mutation. This is a consequence of mutations positions in tskit being in floating-point values but normal genomic locations being integer values.
